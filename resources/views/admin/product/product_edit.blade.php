...
<div class="container-full">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <select name="brand_id" id="select"  class="form-control" required="">
                            ...
                            @foreach($brands as $b)
                            <option value="{{$b->id}}" {{$b->id == $product->brand_id ? 'selected' : ''}}>{{$b->brand_name_en}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <select name="category_id" id="select"  class="form-control" required="">
                            ...
                            <option value="{{$c->id}}" {{$c->id == $product->category_id ? 'selected' : ''}}>{{$c->category_name_en}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <select name="subcategory_id" id="select"  class="form-control" required="">
                            ...
                            <option value="{{$sc->id}}" {{$sc->id == $product->subcategory_id ? 'selected' : ''}}>{{$sc->subcategory_name_en}}</option>
                            @endforeach
                        </select>
                        </select>
                    <div class="help-block"></div></div>
             ...
             <div class="form-group">
                 ...
                 <div class="controls">
                     <select name="subsubcategory_id" id="select"  class="form-control" required="">
                         ...
                         <option value="{{$ssc->id}}" {{$ssc->id == $product->subsubcategory_id ? 'selected' : ''}}>{{$ssc->subsubcategory_name_en}}</option>
                         @endforeach
                     </select>
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_name_id" class="form-control" required="" value="{{$product->product_name_id}}">
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_code" class="form-control" required="" value="{{$product->product_code}}"></div></div>
                        @error('product_code')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_qty" class="form-control" required="" value="{{$product->product_qty}}"></div></div>
                        @error('product_qty')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input type="text" name="product_tags_en" value="{{$product->product_tags_en}}" required="" data-role="tagsinput"  style="display: none;"> </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                               ...
                               <input type="text" name="product_tags_id" value="{{$product->product_tags_id}}" required="" data-role="tagsinput"  style="display: none;"> </div>
                            </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <h5>Product Size En <span class="text-danger">*</span></h5>
                               <input type="text" name="product_size_en" value="{{$product->product_size_en}}"  data-role="tagsinput"  style="display: none;"> </div>
                            </div>
                        
                        <div class="col-md-4">
                            <div class="form-group">
                                <h5>Product Size Id <span class="text-danger">*</span></h5>
                               <input type="text" name="product_size_id" value="{{$product->product_size_id}}" data-role="tagsinput"   style="display: none;"> </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="selling_price" class="form-control" required="" value="{{$product->selling_price}}" ></div></div>
                                @error('selling_price')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="discount_price" class="form-control"  value="{{$product->selling_price}}"></div></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <textarea name="short_descp_id" id="textarea" class="form-control" required=""  placeholder="Textarea text">{{$product->short_descp_id}}</textarea>
                                <div class="help-block"></div></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <textarea name="long_descp_id" id="editor2" class="form-control" require="" placeholder="Textarea text">{!!$product->long_descp_id!!}</textarea>
                                <div class="help-block"></div></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <button class="btn btn-primary" type="submit" style="border-radius: 50px">Update Product</button>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <h4 class="box-title ml-3 mt-3">Edit Multi Image</h4>
                    <form action="{{route('product.update.multiImg')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="col-md-3 ml-3 mt-3">
                        ...
                        <div class="card" style="width: 18rem;">
                            <img src="{{asset($img->photo_name)}}" class="card-img-top" style="width:280px; height:280px">
                            <div class="card-body">
                              <h5 class="card-title">
                                  <a href="{{route('product.multiImg.delete', $img->id)}}" id="delete"><i class="fa fa-trash text-danger" aria-hidden="true"></i></a>
                              </h5>
                              <div class="form-group">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col">
                <div class="box bt-3 border-info">
                    <h4 class="box-title ml-3 mt-3">Edit Product Thumbnail</h4>
                    ...
                    <div class="col-md-3 ml-3 mt-3">
                        ...
                        <div class="card" style="width: 18rem;">
                            <img src="{{asset($product->product_thumbnail)}}" class="card-img-top" style="width:280px; height:280px">
                            <div class="card-body">
                              <h5 class="card-title">
                              ...
                              <div class="form-group">
                                  <label for="">Change Image</label>
                                  <input type="file" class="form-control" name="product_thumbnail_new" onchange="mainThamUrl(this)">
