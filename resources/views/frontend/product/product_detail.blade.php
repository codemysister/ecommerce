...
@section('title')
  {{$product->product_name_en}} Detail
@endsection
@section('home')
@php
	$hot_deals = App\Models\Product::where('hot_deals', 1)->where('discount_price', '!=', NULL)->limit(3)->get();
@endphp
                ...
                @endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name">@if(Session::get('Language') == 'Indonesia') {{$product->product_name_id}} @else {{$product->product_name_en}} @endif</h1>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											@php
												$selisih = $product->selling_price - $product->discount_price;
												$discount = ($selisih / $product->selling_price) * 100;
											@endphp
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<select class="form-control unicase-form-control selectpicker" style="">
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">@if(Session::get('Language') == 'Indonesia') {!!$product->long_descp_id!!} @else {!!$product->long_descp_en!!} @endif</p>
									</div>	
								</div><!-- /.tab-pane -->
