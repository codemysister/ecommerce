                    ...
                    <div class="accordion-group">
                      ...
                      <div class="accordion-body collapse" id="collapse{{$category->id}}" style="height: 0px;">
                        <div class="accordion-inner">
                          ...
                          <ul>
                            <li><a href="#">@if(Session::get('Language') == 'Indonesia') {{$subcategory->subcategory_name_id}} @else {{$subcategory->subcategory_name_en}} @endif</a></li>
                          </ul>
                          @endforeach
                        </div>
                        <!-- /.accordion-inner --> 
                        ...
                        <div class="row product-list-row">
                          ...
                          <div class="col col-sm-8 col-lg-8">
                            <div class="product-info">
                              ...
                              <!-- /.product-price -->
                              <div class="description m-t-10">@if(Session::get('Language') == 'Indonesia') {{$product->short_descp_id}} @else {{$product->short_descp_en}} @endif</div>
                              <div class="cart clearfix animate-effect">
                                <div class="action">
                                  <ul class="list-unstyled">
                                    <li class="add-cart-button btn-group">
